...
function App() {
    ...
    try {
      ...
      const companyTable = new Table({
        rows: [
          ...
          new TableRow({
            children: [
              new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: "GST No", bold: true })] })] }),
          ...
          new TableRow({
            children: [
              new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: "TWB Order No", bold: true })] })] }),
              new TableCell({ children: [new Paragraph(formData.twbOrder)] }),
            ],
          }),
          new TableRow({
            children: [
              new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: "Number of Loadings", bold: true })] })] }),
  ...
  return (
    <div className="min-h-screen bg-brandGray p-6 flex justify-center">
      <div className="w-full max-w-5xl bg-white rounded-2xl shadow-lg p-8 border border-brandGreen">
        {/* Header */}
        ...
        <button
          ...
          className="bg-brandYellow hover:bg-yellow-400 text-brandText font-bold p-3 rounded mt-6 w-full shadow-md"
        >
          Download as Word
        </button>
      </div>
